          ...
          <div class="layui-card-body" pad15="">
            <div class="layui-form" lay-filter="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="name" value="<?= $model->name?>" lay-verify="nickname" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">头像</label>
                  <div class="form-group field-admin-username required">
                      <a class=btn_addPic href="javascript:void(0);"><span>更改头像</span>
                          <input class="filePrew" title=支持jpg、jpeg、gif、png格式，文件小于5M id="avatarSelect" type="file" name="Admin[avatar]"></a>
